...
if (isset($_POST['submit'])) 
{
	...
	{	
		...
		$sql = "SELECT * 
						FROM Illness as i inner join Patient as p
						ON i.idPatient = p.idPatient
	...
	<?php 
		...
		{ ?>
			<tr>
				...
				<td><?php echo escape($row["ill_name"]); ?></td>
...
<h2>View Patient Illness History</h2>
