                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                <form method="post">
                                                    	...
                                                    	<tr>
                                                        	<th scope="row"><label for="allergy_name">Name of Allergy</label></th>
                                                        	<td><input type="text" name="allergy_name" id="allergy_name"></td>
                                                    	</tr>
                                                    	<tr>
                                                        	<th scope="row"><label for="description">Description of Allergy</label></th>
